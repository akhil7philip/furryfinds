...
const CONFIG = {
  ...
  repo: process.env.GITHUB_REPO || 'furryfinds',
...
const articleData = {
  title: "Best Pet Accessories for Camping in 2026",
  excerpt: "We tested 12 top-rated pet accessories to find the best options for camping, van life, and outdoor adventures. Here's what actually works.",
  content: `# Best Pet Accessories for Camping in 2026
